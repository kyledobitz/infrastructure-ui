describe("infrastructure.ui.index", function() {

    var $rootScope, $state, $location;

    beforeEach(angular.mock.module('infrastructure.ui.index', function() {
    ...
    beforeEach(angular.mock.inject(function (_$rootScope_, $templateCache, _$state_, _$location_) {
        ...
        $templateCache.put('/infrastructure/ui/index/index.html', '');
    }));
